...
function aegad_map_fullwidth_design() {
    ...
    /* ========== 5. إصلاح Best Things to Do Section ========== */
    /* Override the 80vh height constraint */
    html body .elementor-element-7fd6f4bb,
    html body section.elementor-element-36380079 {
        min-height: auto !important;
        height: auto !important;
        overflow: visible !important;
    }

    html body .elementor-element-7fd6f4bb .listing-with-sidebar,
    html body section.elementor-element-36380079 .listing-with-sidebar {
        height: auto !important;
        overflow: visible !important;
    }

    html body .elementor-element-7fd6f4bb .listing-with-sidebar__listing,
    html body section.elementor-element-36380079 .listing-with-sidebar__listing {
        position: static !important;
        height: auto !important;
        overflow: visible !important;
    }

    html body .elementor-element-7fd6f4bb .listing-with-sidebar__wrapper,
    html body section.elementor-element-36380079 .listing-with-sidebar__wrapper {
        height: auto !important;
        overflow: visible !important;
    }

    /* Grid layout for cards */
    html body .elementor-element-7fd6f4bb .directorist-archive-items,
    html body section.elementor-element-36380079 .directorist-archive-items {
    ...
    html body .elementor-element-7fd6f4bb .directorist-listing-card,
    html body section.elementor-element-36380079 .directorist-listing-card {
    ...
    /* 6. New Cards Container */
    #aegad-cards-container {
    ...
    /* Footer Text Widget */
    html body .footer-light .widget_text,
    html body .footer-light .widget_text .textwidget,
    html body .footer-light .widget_text .textwidget p {
    ...
    /* Footer Logo Styling */
    html body .footer-light .widget_media_image img,
    html body .footer-widgets .widget_media_image img {
    ...
    html body .footer-light h1,
    html body .footer-light h2,
    html body .footer-light h3,
    html body .footer-light h4,
    html body .footer-light h5,
    html body .footer-light .widget-title,
    ...
    html body .footer-light a,
    html body .footer-top a,
    html body .footer-widgets a,
    html body .footer-bottom a {
        color: #64ffda !important;
    }
    
    html body .footer-light a:hover,
    html body .footer-widgets a:hover {
        color: #ffffff !important;
    }
    
    html body .footer-light .social-basic a,
    html body .footer-widgets .social-basic a {
        background: rgba(100, 255, 218, 0.15) !important;
        border: 1px solid #64ffda !important;
        color: #64ffda !important;
    }
    
    html body .footer-light .social-basic a:hover,
    html body .footer-widgets .social-basic a:hover {
    ...
    (function() {
        ...
        // إعادة بناء Best Things Section بالكامل
        function rebuildBestThingsSection() {
            if (document.getElementById('aegad-best-things-rebuilt')) return;

            var section = document.querySelector('.elementor-element-7fd6f4bb');
            if (!section) return;

            // جمع بيانات الكروت قبل الحذف
            var cards = section.querySelectorAll('.directorist-listing-card');
            ...
            newSection.id = 'aegad-best-things-rebuilt';
            newSection.innerHTML = `
                <div style="text-align: center; padding: 40px 20px 20px;">
                    <h2 style="font-size: 32px; font-weight: 700; color: #1a1a2e; margin-bottom: 10px;">Best Things to Do in the City</h2>
                    <p style="color: #666; font-size: 16px;">Explore the popular listings around the world</p>
                </div>
                <div id="aegad-cards-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 25px; padding: 20px; max-width: 1200px; margin: 0 auto;">
                    ${cardsHTML.join('')}
                </div>
                <div style="text-align: center; padding: 30px 0 50px;">
                    <a href="/all-listings/" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #fff; padding: 16px 50px; border-radius: 50px; font-size: 17px; font-weight: 600; text-decoration: none; box-shadow: 0 4px 15px rgba(102,126,234,0.4); text-transform: uppercase; letter-spacing: 1px;">Explore All →</a>
                </div>
            `;

            // استبدال السكشن القديم
            var parent = section.closest('.elementor-top-section') || section.parentElement;
            if (parent) {
                parent.style.cssText = 'height: auto !important; min-height: auto !important; overflow: visible !important;';
                parent.innerHTML = '';
            ...
            style.textContent = `
                @media (max-width: 992px) {
                    #aegad-cards-grid { grid-template-columns: repeat(2, 1fr) !important; }
                }
                @media (max-width: 576px) {
                    #aegad-cards-grid { grid-template-columns: 1fr !important; }
                }
                #aegad-cards-grid .directorist-listing-card {
                    width: 100% !important;
                    max-width: 100% !important;
                    height: auto !important;
                }
            ...
            console.log('AEGAD: Best Things section rebuilt with', cardsHTML.length, 'cards');
        }

        
        // حذف السكشنات غير المطلوبة
        function removeUnwantedSections() {
            // حذف Explore Hot Locations
            var headings = document.querySelectorAll('h2, h3, .elementor-heading-title');
            headings.forEach(function(h) {
                var text = h.textContent || '';
                if (text.includes('Explore Hot Locations') || text.includes('Most Popular')) {
                    var section = h.closest('.elementor-section') || h.closest('.elementor-top-section') || h.closest('.elementor-element');
                    if (section) {
                        section.remove();
                        console.log('AEGAD: Removed section - ' + text);
                    }
                }
            });
            
            // حذف أي سكشن فيه most-popular أو hot-locations
            var selectors = [
                '[class*="hot-location"]',
                '[class*="most-popular"]',
                '[class*="popular-location"]',
                '.elementor-widget-dlist-locations'
            ];
            selectors.forEach(function(sel) {
                var elements = document.querySelectorAll(sel);
                elements.forEach(function(el) {
                    var section = el.closest('.elementor-section') || el.closest('.elementor-top-section');
                    if (section) {
                        section.remove();
                        console.log('AEGAD: Removed by selector - ' + sel);
                    }
                });
            });
        }
        ...
        // تغيير لوجو الفوتر وإظهار النص
        function changeFooterLogo() {
            // تغيير اللوجو
            var footerLogos = document.querySelectorAll('.footer-light img[src*="logo-white"], .footer-widgets img[src*="logo-white"], .footer-light .widget_media_image img, .widget_media_image img[src*="logo"]');
            footerLogos.forEach(function(img) {
                img.src = 'https://sa.aegad.com/wp-content/uploads/aegad-logos/logo-small.png';
                img.style.cssText = 'width: 80px !important; height: auto !important; filter: brightness(0) invert(1) !important; display: block !important; margin-bottom: 15px !important;';
            });
            
            // إظهار النص بجوار اللوجو
            var footerTexts = document.querySelectorAll('.footer-light .widget_text, .footer-light .textwidget, .footer-light .widget_text p, .footer-light .textwidget p');
            footerTexts.forEach(function(el) {
                el.style.cssText = 'display: block !important; visibility: visible !important; color: #b0b0b0 !important; font-size: 14px !important; line-height: 1.8 !important; opacity: 1 !important; height: auto !important; width: auto !important; position: static !important; margin-top: 10px !important;';
            });
        }
        ...
        setTimeout(rebuildBestThingsSection, 2000);
    })();
    </script>
    <?php
}
